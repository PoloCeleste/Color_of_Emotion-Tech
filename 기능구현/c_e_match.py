'''
1 https://www.ijert.org/a-link-between-colors-and-emotions-a-study-of-undergraduate-females
2 https://looka.com/blog/colors-and-emotions/
3 https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2022.515215/full
4 https://pmc.ncbi.nlm.nih.gov/articles/PMC4383146/
5 https://www.jdsd.in/color-psychology-understanding-the-impact-of-color-on-emotions-and-behavior/
'''
...
# 제공된 emotion_color_dict 사용 (이전에 정의한 딕셔너리)
emotion_color_dict = {
    'Joy': [
        (255, 255, 0),  # 밝은 노란색
        (255, 215, 0)   # 금색 [1]
...
try:
    ...
    for emotion, colors in emotion_color_dict.items():
        for color in colors:
            distance = calculate_distance(user_rgb, color)
